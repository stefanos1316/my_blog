...
\newcommand{\NewsletterName}[2]{ % Newsletter title
\begin{center}
...
\newcommand{\JournalIssue}[2]{ % Date and issue number at the top of the newsletter
\hfill \textsc{10th of April 2018, No #1} % Right-aligned date and issue number
\par \normalsize \normalfont}
...
offering strong sunlight most of the year, amazing beaches, kind and friendly people 
with great hospitality, chill and easy going lifestyle. 
...
And one thing I know for sure is that I could never be the person that I am today 
if I hadn't taken the big leap and exit my comfort zone.
}
