...
I never thought before that: traveling; meeting new people; learning new things; 
...
traveling aspect as part of my life?
...
traveling to Saint-Petersburg by bus---towards our Ukrainian fellow, Vitali Poliakov 
(another techno-freak, that you can align with Alexandre De Masi, combined with 
the slow eating behavior, his usual quote \textit{``no no stop stop stop"}, and  
...
passports and languages was our welcome ceremony to mother Russia.


\begin{center}
	\includegraphics[width=0.32\textwidth]{media/accommodation_in_spb.jpg}
	\par\textit{After seeing our accommodation}
\end{center}
...
The white nights are starting from beginning of June and last for two weeks 
